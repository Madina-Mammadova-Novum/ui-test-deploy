...
export default async function handler(req, res) {
  ...
  const test = getApiURL(
    `v1/${role}/deals/searchdeal?Skip=${req.body.skip}&PageSize=${req.body.pageSize}${queryParams}`
  );
  console.log({ test });
  ...
  return responseHandler({
    req,
    res,
    path: getApiURL(`v1/${role}/deals/searchdeal?Skip=${req.body.skip}&PageSize=${req.body.pageSize}${queryParams}`),
