...
const AccountTools = () => {
    ...
    return (
        <section>
            <div className=" pt-5">
                <Title className="mb-5" level={1}>Tools</Title>
                <div className="flex justify-between rounded-base bg-white divide-gray-darker p-5">
                            ...
                            <FormProvider  {...methods} >
                                <div className=" gap-[34px] flex flex-col">
                                    ...
                                    <FormDropdown
                                        ...
                                        options={testOption} label="from which port" />
                                    <FormDropdown
                                        defaultValue="Some category"
                                        error={errors.calc?.message}
                                        name="toPort"
                                        onChange={(option) => handleChange('toPort', option)}
                                        options={testOption} label="to which port" />
                                </div>
                                <div className="pt-[34px]">
                                    <FormDropdown
                                        ...
                                        options={testOption} label="additional port" />
                                </div>
                            </FormProvider>
                            <div>
                                <Button
                    ...
                    <div><NextImage className="w-[1000px]" src={staticMap} /></div>
                </div>
            </div >
        </section >
    );
