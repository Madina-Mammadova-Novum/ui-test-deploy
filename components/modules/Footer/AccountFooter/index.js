...
export default function AccountFooter({ socials, legal }) {
  return (
    <InAppChecker>
      <footer className="mt-[1.875rem] flex flex-col items-start gap-2.5 bg-white px-5 py-2 text-xs-sm shadow-xmd md:grid md:grid-cols-6 md:items-center md:py-4 3md:grid-cols-3">
