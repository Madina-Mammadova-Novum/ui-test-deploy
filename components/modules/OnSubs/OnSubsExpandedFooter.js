...
const OnSubsExpandedFooter = ({ underRecap = true, offerId, identity }) => {
  const printCta = () => {
    const justifyClass = underRecap ? 'justify-between' : 'justify-end';
      ...
      <div className={`flex gap-x-5 ${justifyClass} pt-2.5`}>
        <div className="w-full grow">
          <Button
            buttonProps={{
              text: underRecap
                ? 'The recap is being finalized'
                : identity?.isOwner
                  ? 'Waiting for counterparty to lift the subs'
                  : 'To lift the subs, please use our mobile app',
                ...
                >
                  <div className="flex flex-col items-center p-4 text-center">
                    <div className="mb-4 text-xsm font-semibold text-gray-900">
                      The lifting process is handled in our mobile app. If you&apos;ve already downloaded it, please
                      open the app now. Otherwise, scan the QR code below to download the app.
                    </div>
