  ...
  return (
    <section className="">
      <div className="container mx-auto max-w-[960px]">
        ...
        {shortDescription && <p className="text-black text-xsm my-2.5">{shortDescription}</p>}
        {quote && <p className="my-4 py-2 pl-4 text-black text-xsm font-semibold border-l-2 border-blue">{quote}</p>}
        {description && (
          <div>
