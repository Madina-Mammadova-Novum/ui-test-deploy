          ...
          <div className="flex-1">
            ...
            {role === 'owner' ? (
              <div className="divide-y divide-gray-darker mt-1">
                ...
                <div className={classnames(open ? 'relative border-none rounded-[10px] pt-[30px] bg-white shadow-xmd' : 'pt-[20px]', 'text-black pb-2.5 peer:bg-blue-500')}>
                  <div className="flex justify-between pb-2.5 px-[30px]">
                    ...
                    <Button
                      ...
                      onClick={handleOpen}
                      buttonProps={{ text: '', variant: 'tertiary', size: 'small', icon: open ? <MinusIcon width={24} height={24} /> : <PlusIcon width={24} height={24} /> }}
                    />
                  </div>
                  {open && (
