...
export const BlockCtaFeaturedPropTypes = {
  title: PropTypes.string.isRequired,
...
export const BlockJoinTeamPropTypes = {
  title: PropTypes.string.isRequired,
  shortDescription: PropTypes.string.isRequired,
...
export const BlockImprovementsPropTypes = {
  title: PropTypes.string,
  values: PropTypes.arrayOf(valuesPropTypes).isRequired,
};

export const BlockPrivacyPolicyPropTypes = {
  title: PropTypes.string.isRequired,
  content: PropTypes.string.isRequired,
};

export const BlockTestimonialsPropTypes = {
  title: PropTypes.string,
  shortDescription: PropTypes.string,
  testimonials: PropTypes.arrayOf({}),
};

export const ContactUsBlockPropTypes = {
  title: PropTypes.string,
  subTitle: PropTypes.string,
  shortDescription: PropTypes.string,
...
export const CTABlockPropTypes = {
  title: PropTypes.string,
  shortDescription: PropTypes.string,
  buttons: PropTypes.arrayOf(
    PropTypes.shape({
...
export const CtaImagesPropTypes = {
  items: PropTypes.arrayOf({
    id: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
    title: PropTypes.string.isRequired,
...
export const CTASingleImageBlockPropTypes = {
  title: PropTypes.string,
  shortDescription: PropTypes.string,
  button: linkPropTypes,
  coverImage: mediaPropTypes,
...
export const FAQBlockPropTypes = {
  title: PropTypes.string,
  subTitle: PropTypes.string,
  shortDescription: PropTypes.string,
  items: PropTypes.arrayOf(
...
export const FooterNavigationPropTypes = {
...
export const HeroAnimatedTitlePropTypes = {
  title: PropTypes.string,
  shortDescription: PropTypes.string,
  button: linkPropTypes,
...
export const BlockHowItWorksPropTypes = {
  title: PropTypes.string.isRequired,
  shortDescription: PropTypes.string.isRequired,
...
export const ImageSliderBlockPropTypes = {
...
export const JoinTeamModalPropTypes = {
  closeModal: PropTypes.func.isRequired,
};

export const ProductFeaturesBlockPropTypes = {
  title: PropTypes.string,
  coverImage: mediaPropTypes,
...
export const SimpleContentBlockPropTypes = {
  title: PropTypes.string,
  content: PropTypes.string,
};

export const TeamBlockPropTypes = {
  title: PropTypes.string,
  subTitle: PropTypes.string,
  shortDescription: PropTypes.string,
...
export const ValuesSelectedPropTypes = {
  title: PropTypes.string,
  shortDescription: PropTypes.string,
  values: valuesPropTypes,
};
...
export const WhatWeOfferBlockPropTypes = {
  title: PropTypes.string,
  values: valuesPropTypes,
};
