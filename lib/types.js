...
export const TankerExpandedFooterPropTypes = {
  tankerId: PropTypes.number.isRequired,
};
...
export const PostFixtureResultContent = {
  data: PropTypes.arrayOf(PropTypes.shape({})).isRequired,
  toggle: PropTypes.bool,
};
...
export const UnassignedFleetExpandedContentPropTypes = {
  rowsData: PropTypes.arrayOf(PropTypes.shape({})).isRequired,
};
...
export const NotificationContentPropTypes = {
  data: PropTypes.arrayOf(PropTypes.shape({})).isRequired,
...
export const OfferDetailsPropTypes = {
  voyageDetails: PropTypes.shape({}).isRequired,
  commercialOfferTerms: PropTypes.shape({}).isRequired,
};
...
export const ChatConversationPropTypes = {
  ...
  onCollapseSession: PropTypes.func.isRequired,
};
...
export const ProvidersPropTypes = {
  loader: PropTypes.oneOf(['page', 'component']),
};

export const AccountContainerPropTyes = {
