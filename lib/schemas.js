...
export const phoneSchema = () => yup.string().required(requiredMessage).matches(phoneRegEx, 'Phone number is not valid')
...
export const tankerDataSchema = () => ({
  ...
  built: yup.object().shape({ value: yup.string().required(requiredMessage) }),
  ...
  tankerCategory_1: yup.object().shape({ value: yup.string().required(requiredMessage) }),
  tankerCategory_2: yup.object().shape({ value: yup.string().required(requiredMessage) }),
  ...
  summmerDraft: yup.string().required(requiredMessage),
  normalBallastWDT: yup.string().required(requiredMessage),
  ...
  grades: yup.object().shape({ value: yup.string().required(requiredMessage) }),
